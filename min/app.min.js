...
"use strict";angular.module("dnsim").controller("HeaderCtrl",[function(){var e=this;e.doClose=function(){localStorage.setItem("notice1",!0),e.isClosed=!0},e.isClosed=null!=localStorage.getItem("notice1")}]).directive("dngearsimHeader",function(){return{templateUrl:"ui/nav/header.html",controller:"HeaderCtrl",controllerAs:"ctrl"}});
...
"use strict";!function(){function e(e,t,n,a,i,r,l,s,o){return{encodeItem:function(e,t){if(e){var n;return"custom"==e.typeName?(n="_custom",angular.forEach(e.stats,function(e,t){n+=t>0?"|":":C",n+=e.id.toString(36)+"="+e.max})):e.id&&(n="I"+e.id.toString(36)+":_","itemSource"in e?n+=e.itemSource:"itemTypeName"in e?n+=e.itemTypeName:e.fileName&&(n+=":F"+e.fileName),(e.enchantmentNum||0==e.enchantmentNum)&&(n+=":E"+e.enchantmentNum.toString(36)),e.pid>0&&(n+=":P"+e.pid.toString(36)),e.sparkId>0&&(n+=":H"+e.sparkId.toString(36)),"skills"==e.typeName&&(n+=":J"+e.baseJobName),e.pve&&(n+=":V"+e.pve)),e.name&&!t&&(n+=":."+e.name.replace(/ /g,"-").replace(/\//g," ")),n}return""},decodeItem:function(t){var n={};return t&&angular.forEach(t.split(":"),function(t,a){if("I"==t.charAt(0))n.id=parseInt(t.substr(1),36);else if("E"==t.charAt(0))n.enchantmentNum=parseInt(t.substr(1),36);else if("P"==t.charAt(0))n.pid=parseInt(t.substr(1),36);else if("S"==t.charAt(0))n.setId=parseInt(t.substr(1),36);else if("H"==t.charAt(0))n.sparkId=parseInt(t.substr(1),36);else if("J"==t.charAt(0))n.baseJobName=t.substr(1);else if("V"==t.charAt(0))n.pve=t.substr(1);else if("_"==t.charAt(0))n.itemSource=t.substr(1);else if("."==t.charAt(0))n.name=t.substr(1).replace("-"," ");else if("C"==t.charAt(0)){n.stats=[];var i=t.substr(1);angular.forEach(i.split("|"),function(e,t){var a=e.split("=");n.stats.push({id:parseInt(a[0],36),max:Number(a[1])})})}else"F"==t.charAt(0)&&(n.fileName=t.substr(1),angular.forEach(e,function(e,t){e.mainDnt&&0==e.mainDnt.indexOf(n.fileName+".")&&(n.itemSource=t)}))}),n},createGroupLink:function(e,t){var n=[],a=this;if(null==t)return"";angular.forEach(t.items,function(e,t){var i=a.encodeItem(e,!0);i&&i.length&&n.push(i)});var i="view-group?region=";return o.dntLocation&&o.dntLocation.region&&(i+=o.dntLocation.region),t.enemyLevel&&(i+="&e="+t.enemyLevel),t.playerLevel&&(i+="&p="+t.playerLevel),t.heroLevel&&(i+="&h="+t.heroLevel),t.job&&t.job.id&&(i+="&j="+t.job.id),t.damageType&&t.damageType.id&&(i+="&d="+t.damageType.id),t.element&&t.element.id&&(i+="&t="+t.element.id),t.secondaryElement&&t.secondaryElement.id&&(i+="&s="+t.secondaryElement.id),i+="&g="+encodeURI(e)+"&i="+n.join(",")},reloadSkill:function(e){e.enchantmentNum||(e.enchantmentNum=1);var n="skilltable_character"+e.baseJobName+".json",i="pve";"pvp"==e.pve&&(i="pvp");var s="skillleveltable_character"+e.baseJobName+i+".json",o=t.find(n,"id",e.id)[0];o||console.log("cannot get skill data from ",n);var m=t.getData(s),c={};angular.forEach(m,function(t,n){t.SkillIndex==e.id&&t.SkillLevel==e.enchantmentNum&&(c=t)});var u={id:e.id,itemSource:e.itemSource,typeName:e.itemSource,needJobClass:o.NeedJob,baseJobName:e.baseJobName,rank:a.rankNames[0],enchantmentNum:e.enchantmentNum,name:l.translate(o.NameID,o.NameIDParam),description:l.translate(c.SkillExplanationID,c.SkillExplanationIDParam),icon:o.IconImageIndex,pve:e.pve};return u.stats=r.getSkillStats(u,o,m),u},reloadSourceItem:function(i){var r=e[i.itemSource],l=t.findFast(r.mainDnt,"id",i.id);if(!l.length)return void console.log("item "+i.id+" not found in "+r.mainDnt);var o=l[0],m=t.getValue(r.mainDnt,o,"TypeParam1"),c=null,u=t.find(r.potentialDnt,"id",i.pid);u.length||(u=t.find(r.potentialDnt,"PotentialID",m)),u.length||(u=t.find(r.potentialDntEx,"id",i.pid),u.length||(u=t.find(r.potentialDntEx,"PotentialID",m))),u.length>0&&(c=u[0],c.PotentialID!=m&&(c=null,console.log("bad potential")));var d=n.createItem(r,o,c);n.initItem(d),s.setItemCategory(d),d.gemSlot=i.gemSlot;var f=null;if((f="weapons"!=d.typeName&&0!=d.typeId?"partsDnt":"weaponDnt")&&t.isLoaded(r[f])&&t.isLoaded(r.setDnt)){d.setStats=[];var p=t.find(r[f],"id",i.id);if(p.length>0){d.setId=p[0].SetItemID;var h=t.find(r.setDnt,"id",p[0].SetItemID);h.length>0&&(d.setStats=a.getStats(h[0]))}}if(d.fullStats=d.stats,i.enchantmentNum>=0)if(d.enchantmentNum=i.enchantmentNum,"skills"==d.typeName);else if("talisman"==d.typeName){var S=[],g=a.mergeStats(d.stats,[]);angular.forEach(g,function(e,t){S.push({id:e.id,max:e.max*(d.enchantmentNum/100)})}),d.enchantmentStats=S}else if(r.enchantDnt){var v=t.find(r.enchantDnt,"EnchantID",d.enchantmentId);!v.length&&r.enchantDnt2&&(v=t.find(r.enchantDnt2,"EnchantID",d.enchantmentId)),angular.forEach(v,function(e,t){e.EnchantLevel==d.enchantmentNum&&(d.enchantmentStats=a.getStats(e))})}else if(r.petLevelDnt){var N=t.find(r.petLevelDnt,"PetLevelTypeID",d.enchantmentId);angular.forEach(N,function(e,t){e.PetLevel==d.enchantmentNum&&(d.enchantmentStats=a.getStats(e))})}if(d.enchantmentStats&&(d.fullStats=a.mergeStats(d.enchantmentStats,d.stats)),i.sparkId>0){d.sparkId=i.sparkId;var D=t.find(r.sparkDnt,"id",i.sparkId);D.length>0&&(d.sparkStats=a.getStats(D[0]),d.fullStats=a.mergeStats(d.fullStats,d.sparkStats))}else if(d.dragonjeweltype){d.offensiveGemSlots=0,d.increasingGemSlots=0;var I=t.find("dragonjewelslottable.json","DragonJewelID",d.dragonjeweltype);I&&I.length>0&&(1==I[0].DragonJewelSlot1&&d.offensiveGemSlots++,1==I[0].DragonJewelSlot2&&d.offensiveGemSlots++,1==I[0].DragonJewelSlot3&&d.offensiveGemSlots++,1==I[0].DragonJewelSlot4&&d.offensiveGemSlots++,2==I[0].DragonJewelSlot1&&d.increasingGemSlots++,2==I[0].DragonJewelSlot2&&d.increasingGemSlots++,2==I[0].DragonJewelSlot3&&d.increasingGemSlots++,2==I[0].DragonJewelSlot4&&d.increasingGemSlots++)}return d},reloadItem:function(a){if(null!=a){if("itemTypeName"in a&&!a.itemSource&&(a.itemSource=a.itemTypeName),"rbTech"==a.itemSource&&(a.itemSource="tech"),"custom"==a.itemSource||"custom"==a.typeName)return a.typeName="custom",a;if("skills"==a.itemSource||"skills"==a.typeName)return this.reloadSkill(a);if(a.itemSource in e){var i=e[a.itemSource];if(t.findFast(i.mainDnt,"id",a.id).length)return this.reloadSourceItem(a)}if(a.fileName){var r=t.findFast(a.fileName+".json","id",a.id);if(r.length>0){var s=r[0],o=t.getRow(a.fileName+".json",s),m=n.createBasicItem(o);return m.row=s,m.needJobClass=o.NeedJobClass,m.exchangeType=o.ExchangeType,m.fileName=a.fileName,m.gemSlot=a.gemSlot,m.description=l.translate(o.DescriptionID,o.DescriptionIDParam),n.initItem(m),m}return{name:"unknown item"}}return{name:"unknown item source: "+a.itemSource}}},getDntFiles:function(t){if(null==t)return{};var n={};if(!t.itemSource&&t.itemTypeName in e&&(t.itemSource=t.itemTypeName),"rbTech"==t.itemSource&&(t.itemSource="tech"),t.itemSource in e){var a=e[t.itemSource];n["exchange.json"]=null,n[a.mainDnt]=i.mainDnt;for(var r in a)r.indexOf("Dnt")>0&&("enchantDnt"!=r||"enchantDnt2"!=r||t.enchantmentNum)&&(n[a[r]]=i[r])}if("skills"==t.itemSource||"skills"==t.typeName){n["skilltable_character"+t.baseJobName+".json"]=null;var l="skillleveltable_character"+t.baseJobName+"pve.json";n[l]=null,l="skillleveltable_character"+t.baseJobName+"pvp.json",n[l]=null}return t.fileName&&(n[t.fileName+".json"]=null),n}}}e.$inject=["items","dntData","itemFactory","hCodeValues","itemColumnsToLoad","statHelper","translations","itemCategory","region"],angular.module("dnsim").factory("exportLinkHelper",e)}();
