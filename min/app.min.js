...
"use strict";angular.module("dnsim").controller("buildActionsCtrl",["$location","saveHelper","exportLinkHelper",function(i,t,l){var e=this;this.deleteGroup=function(){i.path("/delete-build/"+e.buildName)},this.editGroup=function(){i.path("/edit-build/"+e.buildName)},this.copyGroup=function(){var l=t.importGroup(e.buildName,e.build.items);t.saveBuild(l,l,e.build),i.path("/build/"+l)},this.reloaded=!1,this.reloadGroup=function(){i.path("/reload-build/"+e.buildName)},this.setShortUrl=function(){if(e.build){var i=l.createGroupLink(e.buildName,e.build);e.build.shortUrl=sessionStorage.getItem(i)}},this.setShortUrl()}]).directive("dngearsimBuildActions",function(){return{scope:!0,bindToController:{buildName:"=buildName",build:"=build",onChange:"&onChange"},controller:"buildActionsCtrl",controllerAs:"buildActions",templateUrl:"ui/builds/build-actions.html"}});
