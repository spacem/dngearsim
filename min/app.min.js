...
"use strict";angular.module("dnsim").controller("BuildTalismansCtrl",["$window","$location","$routeParams","$timeout","saveHelper","statHelper","jobs","hCodeValues","itemColumnsToLoad","character",function(e,t,a,s,n,m,i,r,u,o){function l(e,t){return e&&t?Math.round(1e4*(1-t/e))/100:0}var c=this;if(e.document.title="dngearsim | TALISMANS",e.scrollTo(0,0),this.savedItems=n.getSavedItems(),this.groupNames=Object.keys(this.savedItems),this.groupNames||(this.groupNames=[]),this.groupNames.length>0?this.groupName=n.getCurrentBuild():this.groupName=null,this.groupName&&this.groupName in this.savedItems||this.groupNames.length>0&&(this.groupName=this.groupNames[0]),this.groupName){this.getGroupCalcStats=function(){if(null==this.groupCalcStats){var e=c.savedItems[c.groupName];e&&(this.groupCalcStats=m.getCalculatedStatsFromItems(e,e.items))}return this.groupCalcStats},this.getBuild=function(){return c.savedItems[c.groupName]},this.pickup=function(e){c.selectedIndex=e,c.replaceHPAffectAmount=[],c.replaceMDmgAffectAmount=[],c.replacePDmgAffectAmount=[],c.replaceAvgDmgAffectAmount=[]},this.headers=["+100%","+75%","+25%","+0%"],this.summaryStatIds=[];for(var h in r.stats)r.stats[h].summaryDisplay&&this.summaryStatIds.push(h);this.pcIndexes={},this.pcIndexes[100]=0,this.pcIndexes[75]=1,this.pcIndexes[25]=2,this.pcIndexes[0]=3,this.selectedIndex=-1,this.rows=[],this.updateRows=function(){c.rows=[],angular.forEach(c.savedItems[c.groupName].items,function(e,t){if("talisman"==e.typeName){var a=c.pcIndexes[e.enchantmentNum];a||0==a||(a=3);for(var s=0;;){if(c.rows[s]||(c.rows[s]=c.makeFakeCells()),c.rows[s][a].index<0){e.enchantmentNum||(e.enchantmentNum=0);var n=c.makeCell(e,t);c.rows[s][a]=n;break}s++}}}),c.rows.length<3&&(c.rows[c.rows.length+1]=c.makeFakeCells())},this.makeFakeCells=function(e){return[c.makeCell({enchantmentNum:100},-1),c.makeCell({enchantmentNum:75},-2),c.makeCell({enchantmentNum:25},-3),c.makeCell({enchantmentNum:0},-4)]},this.makeCell=function(e,t){return{item:e,index:t}},this.click=function(e){c.selectedIndex==-1?e.index>=0&&c.pickup(e.index):c.move(e)},this.move=function(e){var t=c.savedItems[c.groupName].items;if(e.index>=0){var a=e.item.enchantmentNum;c.setTalisman(e.item,t[c.selectedIndex].enchantmentNum),c.setTalisman(t[c.selectedIndex],a),t[e.index]=t[c.selectedIndex],t[c.selectedIndex]=e.item}else{var n=t[c.selectedIndex];c.setTalisman(n,e.item.enchantmentNum),t.splice(c.selectedIndex,1),t.push(n)}c.groupCalcStats=null,c.selectedIndex=-1,c.updateRows(),c.replaceAffectAmount={},s()},this.setTalisman=function(e,t){var a=[];angular.forEach(e.stats,function(e,s){t&&a.push({id:e.id,max:Math.floor(e.max)*(t/100)})}),e.enchantmentStats=a,e.enchantmentNum=t,e.fullStats=r.mergeStats(e.enchantmentStats,e.stats)},this.replaceAffectAmount={},this.getReplaceAffectAmount=function(e,t,a){if(this.initReplaceAffects(t,a),this.replaceAffectAmount[t])return this.replaceAffectAmount[t][e]},this.initReplaceAffects=function(e,t){if(!c.replaceAffectAmount[e]&&c.selectedIndex!=-1){this.replaceAffectAmount[e]={};var a=c.savedItems[c.groupName],s=a.items[c.selectedIndex],n=[],i=[];t.stats&&(angular.forEach(t.stats,function(e,t){n.push({id:e.id,max:Math.floor(e.max)*(s.enchantmentNum/100)})}),i=r.mergeStats(n,t.stats)),n=[],angular.forEach(s.stats,function(e,a){n.push({id:e.id,max:Math.floor(e.max)*(t.enchantmentNum/100)})});var u=r.mergeStats(n,s.stats),o=[{stats:i},{stats:u}];angular.forEach(a.items,function(e,a){t!==e&&s!==e&&o.push(e)});var h=m.getCalculatedStatsFromItems(a,o),d=c.getGroupCalcStats();for(var f in r.stats)r.stats[f].summaryDisplay&&(c.replaceAffectAmount[e][f]=l(c.getStat(f,h).max,c.getStat(f,d).max))}},this.getStatName=function(e){var t="";if("primary"==r.stats[e].element){var a=0;c.savedItems[c.groupName].element&&(a=c.savedItems[c.groupName].element.id),t+=r.elements[a].name}else if("secondary"==r.stats[e].element){var a=0;c.savedItems[c.groupName].secondaryElement&&(a=c.savedItems[c.groupName].secondaryElement.id),t+=r.elements[a].name}return t+" "+r.stats[e].name},this.getStat=function(e,t){for(var a=t.length,s=0;s<a;++s)if(t[s].id==e)return t[s];return{id:e,max:0}},this.save=function(){n.updatedSavedItems(c.groupName,c.savedItems[c.groupName].items),t.path("/build"),t.search("buildName",c.groupName)},this.updateRows()}}]);
...
"use strict";angular.module("dnsim").controller("itemViewAttainmentCtrl",["$timeout","dntData","itemFactory","hCodeValues","translations",function(t,n,i,e,a){if(null!=this.item){var l=this;l.attainments=[];for(var o=["itemgaintable.lzjson","itemgaintable_dragonjewel.lzjson","itemgaintable_enchant.lzjson","itemgaintable_etc.lzjson","itemgaintable_reboot.lzjson","itemgaintable_talisman.lzjson"],r=0;r<o.length;++r)n.init(o[r],null,function(){},function(){t(function(){l.init()})});this.init=function(){for(var t=0;t<o.length;++t)if(!n.isLoaded(o[t])&&!n.hasFailed(o[t]))return;l.attainments=[],o.forEach(function(t){var i=n.find(t,"id",l.item.id);i.length&&i.forEach(function(t){var n=t.ItemGainText;if(n){n.split("{").forEach(function(t){var n=t.split("}");n.length&&n[0].indexOf("#")==-1&&l.attainments.push(a.translate(n[0]))})}})})}}}]).directive("dngearsimItemViewAttainment",function(){return{scope:!0,bindToController:{item:"=item"},controller:"itemViewAttainmentCtrl",controllerAs:"ctrl",templateUrl:"ui/item/item-view-attainment.html"}});
"use strict";angular.module("dnsim").controller("itemViewBoxCtrl",["$timeout","dntData","itemFactory","region",function(t,e,i,o){if(null!=this.item){if(46!=this.item.typeId&&8!=this.item.typeId&&112!=this.item.typeId&&122!=this.item.typeId&&142!=this.item.typeId&&160!=this.item.typeId)return void console.log("not box item type "+this.item.typeId);var l=this,n=["itemdroptable.lzjson","itemdroptable_abyss.lzjson","itemdroptable_apprentice.lzjson","itemdroptable_cook.lzjson","itemdroptable_darklair.lzjson","itemdroptable_dimension.lzjson","itemdroptable_disjoint.lzjson","itemdroptable_dnexpedition.lzjson","itemdroptable_event.lzjson","itemdroptable_farm.lzjson","itemdroptable_fishing.lzjson","itemdroptable_guildwar.lzjson","itemdroptable_item.lzjson","itemdroptable_monsteritem.lzjson","itemdroptable_propdrop.lzjson","itemdroptable_pvp.lzjson","itemdroptable_randomcompound.lzjson","itemdroptable_stageclear.lzjson","itemdroptable_themepark.lzjson","itemdroptable_union.lzjson"];this.usedFiles={},this.lookupId=null;var m;46==this.item.typeId||112==this.item.typeId||122==this.item.typeId||142==this.item.typeId||160==this.item.typeId?m=["all-items.lzjson","charmitemtable.lzjson","charmitemtable_common.lzjson"]:8==this.item.typeId&&(m=["all-items.lzjson"].concat(n));for(var s=0;s<m.length;++s)e.init(m[s],null,function(){},function(){t(function(){l.initBoxContents()})});this.initBoxContents=function(){for(var t=0;t<m.length;++t)if(!e.isLoaded(m[t]))return;var i=e.find(this.item.fileName+".lzjson","id",this.item.id);if(i.length>0){var o=i[0];this.lookupId=o.TypeParam1,l.items=[],46==l.item.typeId||112==l.item.typeId||122==l.item.typeId||142==l.item.typeId||160==l.item.typeId?l.getCharmItems(o.TypeParam1):8==l.item.typeId&&l.getPouchItems(o.TypeParam1)}},this.getPouchItems=function(t){for(var e=0;e<n.length;++e)l.getPouchItemsFromFile(t,n[e])},this.getPouchItemsFromFile=function(t,o){var n=e.find(o,"id",t);if(0==n.length);else{var m=n[0].GoldMin,s=0;do{s++;var r=n[0]["IsGroup"+s],a=n[0]["Item"+s+"Index"],d=n[0]["Item"+s+"Info"];if(a)if(r)l.getPouchItems(a,o);else{var p=e.find("all-items.lzjson","id",a);if(p.length>0){var h=i.createBasicItem(p[0]);l.items.push({count:d,gold:m,item:h}),this.usedFiles[o]=!0}}}while(a)}},this.getCharmItems=function(t){for(var o=["charmitemtable.lzjson","charmitemtable_common.lzjson"],n=0;n<o.length;++n)for(var m=e.getData(o[n]),s=0;s<m.length;++s){var r=m[s];if(r.CharmNum==t&&r.Look)if(r.CharmType)this.getCharmItems(r.ItemID);else{var a=e.find("all-items.lzjson","id",r.ItemID);a.length>0&&(l.items.push({count:r.Count,gold:r.Gold,item:i.createBasicItem(a[0])}),this.usedFiles[o[n]]=!0)}}},this.getFileLink=function(t){return"https://spacem.github.io/dntviewer/#dnt="+t+"&location="+o.dntLocation.url}}}]).directive("dngearsimItemViewBox",function(){return{scope:!0,bindToController:{item:"=item"},controller:"itemViewBoxCtrl",controllerAs:"ctrl",templateUrl:"ui/item/item-view-box.html"}});
"use strict";angular.module("dnsim").controller("itemViewCraftCtrl",["$timeout","dntData","itemFactory","hCodeValues","translations",function(t,e,i,n,r){if(null!=this.item){var l=this;l.crafts=[];for(var o=["itemcompoundtable.lzjson","itemcompoundtable_custom.lzjson","itemcompoundtable_glyph.lzjson","itemcompoundtable_glyph95.lzjson","itemcompoundtable_jewel.lzjson","itemcompoundtable_renewal.lzjson","itemcompoundtable_set.lzjson"],a=o.concat(["all-items.lzjson","itemdroptable.lzjson"]),s=0;s<a.length;++s)e.init(a[s],null,function(){},function(){t(function(){l.initCrafts()})});this.initCrafts=function(){for(var t=0;t<a.length;++t)if(!e.isLoaded(a[t])&&!e.hasFailed(a[t]))return;l.crafts=[];for(var t=0;t<o.length;++t)l.initCraft(o[t],l.item.id);for(var i=1;i<=20;++i){var n=e.find("itemdroptable.lzjson","Item"+i+"Index",l.item.id);n.length&&n.forEach(function(t){for(var e=0;e<o.length;++e)l.initCraft(o[e],t.id)})}for(var r=[],t=0;t<l.crafts.length;++t){for(var s=!1,m=0;m<r.length;++m)if(l.crafts[t].gold==r[m].gold&&l.crafts[t].items.length==r[m].items.length){s=!0;for(var f=0;f<l.crafts[t].items.length;++f)l.crafts[t].items[f].item.id==r[m].items[f].item.id&&l.crafts[t].items[f].num==r[m].items[f].num||(s=!1)}s||r.push(l.crafts[t])}l.crafts=r},this.initCraft=function(t,n){for(var r=e.find(t,"SuccessItemID1",n),o=0;o<r.length;++o){for(var a=r[o],s={id:a.id,fileName:t.replace(".lzjson",""),gold:a.Cost/100/100,items:[]},m=0;;){m++;var f="Slot"+m+"Id",c="Slot"+m+"Num";if(!(f in a))break;var d=e.find("all-items.lzjson","id",a[f]);d.length>0&&s.items.push({item:i.createBasicItem(d[0]),num:a[c]})}l.crafts.push(s)}}}}]).directive("dngearsimItemViewCraft",function(){return{scope:!0,bindToController:{item:"=item"},controller:"itemViewCraftCtrl",controllerAs:"ctrl",templateUrl:"ui/item/item-view-craft.html"}});
"use strict";angular.module("dnsim").controller("itemViewExtractionCtrl",["$timeout","dntData","itemFactory","items",function(t,n,i,e){if(null!=this.item){for(var r=this,o=["itemdroptable_disjoint.lzjson","all-items.lzjson"],a=0;a<o.length;++a)n.init(o[a],null,function(){},function(){t(function(){r.initExtract()})});this.initExtract=function(){for(var t=0;t<o.length;++t)if(!n.isLoaded(o[t]))return;var a,l=i.getItemData(r.item);l&&l.DisjointDrop1>0&&(a=l.DisjointDrop1);var m=e[r.item.itemSource];if(m&&l.EnchantID){var c=n.find(m.enchantDnt,"EnchantID",l.EnchantID);!c.length&&m.enchantDnt2&&(c=n.find(m.enchantDnt2,"EnchantID",l.EnchantID));for(var t=0;t<c.length;++t)if(c[t].EnchantLevel==r.item.enchantmentNum){a=c[t].DisjointDrop;break}}r.items=[],a&&r.getItems(a)},this.getGold=function(){var t=i.getItemData(this.item);return Number(t.Disjointamount)/100/100},this.getItems=function(t){var e=n.find("itemdroptable_disjoint.lzjson","id",t);if(0==e.length);else for(var o=e[0].GoldMin,a=1;"Item"+a+"Index"in e[0];){var l=e[0]["IsGroup"+a],m=e[0]["Item"+a+"Index"],c=e[0]["Item"+a+"Info"];if(m)if(l)r.getItems(m);else{var s=n.find("all-items.lzjson","id",m);s.length>0&&r.items.push({count:c,gold:o,item:i.createBasicItem(s[0])})}a++}}}}]).directive("dngearsimItemViewExtraction",function(){return{scope:!0,bindToController:{item:"=item"},controller:"itemViewExtractionCtrl",controllerAs:"ctrl",templateUrl:"ui/item/item-view-extraction.html"}});
...
"use strict";angular.module("dnsim").controller("itemViewShopCtrl",["$timeout","dntData","itemFactory","hCodeValues","translations",function(e,t,s,o,a){function i(e){for(var i=t.find(e,"itemindex",n.item.id),h=0;h<i.length;++h){var r=i[h],u=t.find(m,"id",r.PurchaseItem1),l=t.find(m,"id",r.PurchaseItem2),c={shopName:r.ShopID,tabName:a.translate(r.TabNameID),gold:0,nightmarePoints:0,dungeonPoints:0,nestPoints:0,ladderPoints:0,item1:s.createBasicItem(u[0]),item2:s.createBasicItem(l[0]),numItem1:0,numItem2:0};c.shopName in o.shopNames&&(c.shopName=o.shopNames[c.shopName]),1==r.PurchaseType1?c.gold+=r.PurchaseItemValue1:3==r.PurchaseType1?c.ladderPoints+=r.PurchaseItemValue1:8==r.PurchaseType1?c.nightmarePoints+=r.PurchaseItemValue1:13==r.PurchaseType1?c.nestPoints+=r.PurchaseItemValue1:14==r.PurchaseType1?c.dungeonPoints+=r.PurchaseItemValue1:(c.numItem1=r.PurchaseItemValue1,c.pointsId1=r.PurchaseType1),1==r.PurchaseType2?c.gold+=r.PurchaseItemValue2:3==r.PurchaseType2?c.ladderPoints+=r.PurchaseItemValue2:8==r.PurchaseType2?c.nightmarePoints+=r.PurchaseItemValue2:13==r.PurchaseType1?c.nestPoints+=r.PurchaseItemValue2:14==r.PurchaseType1?c.dungeonPoints+=r.PurchaseItemValue2:(c.numItem2=r.PurchaseItemValue2,c.pointsId2=r.PurchaseType2),c.gold=c.gold/100/100,n.shopCosts.push(c)}}if(null!=this.item){var n=this;n.shopCosts=[];for(var m="all-items.lzjson",h=["combinedshoptable_cash.lzjson","combinedshoptable_system.lzjson","combinedshoptable.lzjson",m],r=0;r<h.length;++r)t.init(h[r],null,function(){},function(){e(function(){n.initShops()})});this.initShops=function(){for(var e=0;e<h.length;++e)if(!t.isLoaded(h[e]))return;n.shopCosts=[],i("combinedshoptable.lzjson"),i("combinedshoptable_system.lzjson"),i("combinedshoptable_cash.lzjson");for(var s=[],e=0;e<n.shopCosts.length;++e){for(var o=!1,a=0;a<s.length;++a)if(n.shopCosts[e].tabName==s[a].tabName&&n.shopCosts[e].gold==s[a].gold&&n.shopCosts[e].item1.id==s[a].item1.id&&n.shopCosts[e].numItem1.id==s[a].numItem1.id&&n.shopCosts[e].item2.id==s[a].item2.id&&n.shopCosts[e].numItem2.id==s[a].numItem2.id){o=!0;break}o||s.push(n.shopCosts[e])}n.shopCosts=s}}}]).directive("dngearsimItemViewShop",function(){return{scope:!0,bindToController:{item:"=item"},controller:"itemViewShopCtrl",controllerAs:"ctrl",templateUrl:"ui/item/item-view-shop.html"}});
...
"use strict";angular.module("dnsim").controller("itemViewTuningCtrl",["$timeout","dntData","itemFactory","hCodeValues",function(e,t,i,n){if(null!=this.item){var r=this;r.rewardItems=[];for(var l=["all-items.lzjson","itemchangetable.lzjson"],a=0;a<l.length;++a)t.init(l[a],null,function(){},function(){e(function(){r.initTransfers()})});this.initTransfers=function(){for(var e=0;e<l.length;++e)if(!t.isLoaded(l[e]))return;r.rewardItems=[];var n=t.find("itemchangetable.lzjson","OriginalItemID",r.item.id);if(n&&n.length>0)for(var e=0;e<n.length;++e){var a=n[e];if(a.OriginalLevel==r.item.enchantmentNum||!a.OriginalLevel){var m=t.find("all-items.lzjson","id",a.RewardItemID);r.rewardItems.push({rewardItem:i.createBasicItem(m[0])})}}}}}]).directive("dngearsimItemViewTuning",function(){return{scope:!0,bindToController:{item:"=item"},controller:"itemViewTuningCtrl",controllerAs:"ctrl",templateUrl:"ui/item/item-view-tuning.html"}});
"use strict";angular.module("dnsim").controller("ItemCtrl",["$scope","$window","dntData","hCodeValues","items","jobs","exportLinkHelper","$routeParams","translations","$location","region","itemFactory","$timeout","statHelper","saveHelper",function(e,t,i,n,a,r,o,m,s,l,u,c,d,f,p){function g(){var t=r.getAllJobs();angular.forEach(t,function(t,i){t.id==e.item.needJobClass&&(e.jobName=t.name)})}function I(){var t=!1;return angular.forEach(o.getDntFiles(e.preInitItem),function(e,n){i.isLoaded(n)||(t=!0)}),!t&&s.isLoaded()&&r.isLoaded()}function v(){if(I()){if(e.item=o.reloadItem(e.preInitItem),null==e.item)return;D(),t.document.title="dngearsim | "+e.item.name,"custom"!=e.item.itemSource&&("skills"==e.item.typeName?e.item.pve&&"pvp"==e.item.pve?e.item.pve="pvp":e.item.pve="pve":e.item.needJobClass>0&&g(),h()),S()}}function S(){var t=c.getItemData(e.item);t.DisjointDrop1>0&&(e.canExtract=!0),(0==t.Type||1==t.Type)&&e.item.enchantmentNum>0&&(e.canTransfer=!0),0!=t.Type&&1!=t.Type||(e.canTune=!0),e.item.setId&&(e.isInSet=!0),5==e.item.typeId&&(e.isPlate=!0),46==e.item.typeId||8==e.item.typeId||112==e.item.typeId||122==e.item.typeId||142==e.item.typeId||160==e.item.typeId?(e.hasContents=!0,e.detail="contents"):null!=e.item.typeName?(e.canUse=!0,e.detail="use"):e.canExtract?e.detail="extract":e.canTransfer?e.detail="transfer":e.canTune?e.detail="tuning":e.isPlate?e.detail="plate":e.detail="attainment"}function h(){e.item.fileName||e.item.itemSource in a&&a[e.item.itemSource].mainDnt&&(e.item.fileName=a[e.item.itemSource].mainDnt.replace(".lzjson","").replace(".json","").replace(".optimised",""))}function D(){e.item.fullStats=e.item.stats,null!=e.item.enchantmentStats&&e.item.enchantmentStats.length>0&&(e.item.fullStats=n.mergeStats(e.item.enchantmentStats,e.item.fullStats)),null!=e.item.sparkStats&&e.item.sparkStats.length>0&&(e.item.fullStats=n.mergeStats(e.item.sparkStats,e.item.fullStats))}function y(e){}function b(){var t=p.getSavedItems();e.builds=t}u.setLocationByName(m.region),t.scrollTo(0,0),e.jobName=null,e.item=o.decodeItem(m.i),"itemSource"in e.item&&(e.itemType=a[e.item.itemSource]),e.item.setStats=null,e.item.setId=null,e.detail=null,e.getDescription=function(){if(e.item.description)return e.item.description;if(e.itemType&&"title"==e.itemType.name&&s.isLoaded()&&i.isLoaded(e.itemType.mainDnt)){var t=i.find(e.itemType.mainDnt,"id",e.item.id);if(t&&t.length>0&&t[0].DescriptionID>0)return s.translate(t[0].DescriptionID,t[0].DescriptionIDParam)}else if(e.item.fileName&&i.isLoaded(e.item.fileName+".lzjson")){var t=i.find(e.item.fileName+".lzjson","id",e.item.id);if(t&&t.length>0&&t[0].DescriptionID>0)return s.translate(t[0].DescriptionID,t[0].DescriptionIDParam)}return""},e.getExchangeType=function(){if(s.isLoaded()&&i.isLoaded("exchange.lzjson")&&e.item.exchangeType>0){var t=i.find("exchange.lzjson","ExchangeType",e.item.exchangeType);if(t&&t.length>0&&t[0].NameID>0)return s.translate(t[0].NameID).toLowerCase()}return""},e.setDetail=function(t){e.detail=t},e.getNumInSet=function(){var t=e.getBuildName();return t&&e.item&&e.item.setId?f.getNumItemsForSet(e.builds[t].items,e.item.setId):0},e.getBuildName=function(){var t=p.getCurrentBuild();if(e.builds&&!(t&&t in e.builds)){var i=Object.keys(e.builds);i.length&&(t=i[0])}return t},e.getSellingPrice=function(){var t=c.getItemData(e.item),i="";if("SellAmount"in t&&t.SellAmount>0){var n=Math.floor(t.SellAmount/1e4);n&&(i+=n+"gold ");var a=Math.floor(t.SellAmount/100)%100;a&&(i+=a+"silver ");var r=t.SellAmount%100;r&&(i+=r+"copper ")}return i},e.getServerStorage=function(){var t=c.getItemData(e.item),i="";return t&&"IsCash"in t&&0==t.IsCash&&(t&&"AbleWStorage"in t&&(1==t.AbleWStorage?i="can server storage":0==t.AbleWStorage&&t&&"Reversion"in t&&t.Reversion&&(i="not transferable")),t&&"Reversion"in t&&(i.length&&(i+=", "),0==t.Reversion?i+="can trade":1==t.Reversion&&(i+="not tradable "))),i},e.getMoreInfo=function(){var t=0,n=0;if(e.moreInfoLoaded()){var a=c.getItemData(e.item);if(a&&"IsCash"in a&&0==a.IsCash){if(a&&"SealID"in a&&"SealCount"in a){t=a.SealCount;var r=i.find("sealcounttable.lzjson","Type2",a.SealID);if(r&&r.length>0&&0==r[0].Type1){var o="Count0";e.item.enchantmentNum&&(o="Count"+e.item.enchantmentNum),o in r[0]&&(n=r[0][o])}}}else if(a&&"IsCash"in a&&"CashTradeCount"in a&&"Reversion"in a&&"AbleWStorage"in a)return 2==a.Reversion?a.CashTradeCount?"can server storage, cash trade count: "+a.CashTradeCount:"can server storage, can use warranty":a.AbleWStorage?"can server storage":"not tradable"}return t&&n?"can stamp "+t+" times using "+n+"  stamps":""},e.moreInfoLoaded=function(){return i.isLoaded(e.item.fileName+".lzjson")&&i.isLoaded("sealcounttable.lzjson")},e.loadMoreInfo=function(){i.init(e.item.fileName+".lzjson",null,d),i.init("sealcounttable.lzjson",null,d)},e.handleChange=function(){"custom"!=e.item.itemSource?l.search("i",o.encodeItem(e.item)):(D(),e.item=angular.copy(e.item)),b()},function(){b(),e.preInitItem=e.item,e.item=null;var t=!1;angular.forEach(o.getDntFiles(e.preInitItem),function(e,n){i.isLoaded(n)||(i.init(n,e,y,v),t=!0)}),s.isLoaded()||(s.init(y,v),t=!0),r.isLoaded()||(r.init(y,v),t=!0),t||v()}()}]);
...
"use strict";!function(){function t(t,n){return{restrict:"A",scope:{stats:"=stats",build:"=build",altStats:"=altStats",separator:"=separator",filter:"=filter",numInSet:"=numInSet"},link:function(e,a,s){function i(){function s(t){var n=a.clone();n.css("display",l),n.html(t),d.after(n),d=n,u.push(n)}a.css("display","none");var i=e.stats;i||(i=e.altStats),angular.forEach(u,function(t,n){t.remove()});var m=!0,d=a,o={};angular.forEach(i,function(n,e){var a=t.stats[n.id];a&&a.summaryFor&&(o[a.summaryFor]=n)}),angular.forEach(i,function(a,u){var l="";if(a.id in t.stats){var d=t.stats[a.id];if(!e.filter&&"hide"in d&&d.hide)return;if(e.filter&&!d[e.filter])return;if(d.summaryFor)return;if(m||(l+=r),m=!1,"needSetNum"in a&&(a.needSetNum<=e.numInSet&&(l+="*"),l+=a.needSetNum+"&nbsp;"),l+="<strong>",e.build)if("primary"==d.element){var c=0;e.build.element&&(c=e.build.element.id),l+=n.instant(t.elements[c].name)+"&nbsp;"}else if("secondary"==d.element){var c=0;e.build.secondaryElement&&(c=e.build.secondaryElement.id),l+=n.instant(t.elements[c].name)+"&nbsp;"}if(l+=n.instant(d.name)+":</strong>&nbsp;"+d.display(a),d.combineWith>0&&angular.forEach(i,function(t,n){t.id==d.combineWith&&t.max!=a.max&&(l+="-"+d.display(t))}),a.id in o){var f=o[a.id];l+="&nbsp;|&nbsp;<em>"+t.stats[f.id].display(f),l+="</em>"}}else m||(l+=r),m=!1,"needSetNum"in a&&(l+=a.needSetNum+"-Increases&nbsp;"),l+=a.id+":&nbsp;"+a.max;s(l)})}var r;r=e.separator?"&nbsp;"+e.separator+" ":"";var u=[],l=a.css("display");e.$watch("stats",function(t,n){t&&i()}),e.$watch("altStats",function(t,n){t&&i()}),e.$watch("numInSet",function(t,n){t>=0&&i()})}}}angular.module("dnsim").directive("dnsimStats",["hCodeValues","$translate",t])}();
...
"use strict";!function(){function t(t,e,n,o){function i(t){}var a="rebootplayerweighttable.lzjson",l="playercommonleveltable.lzjson",r="playerleveltable.optimised.json",s="heroleveltable.lzjson";return{init:function(o){n.init(i,o),t.init(a,e.jobConversionColsToLoad,i,o,!1),t.init(l,e.statCapColsToLoad,i,o,!1),t.init(r,e.jobBaseStatColsToLoad,i,o,!1),t.init(s,null,i,o,!1),t.init("potentialtable_herolevel.lzjson",null,i,o,!1)},getHeroStats:function(e){var n=[];if(e>0){var i=t.findFast(s,"id",e);if(1==i.length){var a=t.getRow(s,i[0]);if(a){var l=t.findFast("potentialtable_herolevel.lzjson","PotentialID",a.HeroLevelAbilityID);if(1==l.length){var r=t.getRow("potentialtable_herolevel.lzjson",l[0]);r&&(n=o.getStats(r))}}}}return n},getStatCaps:function(e){if(e>0){var n=t.findFast(l,"id",e);if(1==n.length)return t.getRow(l,n[0])}return{}},getConversions:function(e){if(e>0){var n=t.findFast(a,"id",e);if(1==n.length)return t.getRow(a,n[0])}return{}},getBaseStats:function(e,n){if(e>0&&n>0){var o=t.findFast(r,"id",100*Number(n)+Number(e)-100);if(1==o.length)return t.getRow(r,o[0])}return{}}}}t.$inject=["dntData","itemColumnsToLoad","jobs","hCodeValues"],angular.module("dnsim").factory("character",t)}();
...
"use strict";!function(){function e(e,t,n,a,i,l,r,o,s,m){return{encodeItem:function(e,t){if(e){var n;return"custom"==e.typeName?(n="_custom",angular.forEach(e.stats,function(e,t){n+=t>0?"|":":C",n+=e.id.toString(36)+"="+e.max})):e.id&&(n="I"+e.id.toString(36)+":_","itemSource"in e?n+=e.itemSource:"itemTypeName"in e?n+=e.itemTypeName:e.fileName&&(n+=":F"+e.fileName),(e.enchantmentNum||0==e.enchantmentNum)&&(n+=":E"+e.enchantmentNum.toString(36)),e.pid>0&&(n+=":P"+e.pid.toString(36)),e.sparkId>0&&(n+=":H"+e.sparkId.toString(36)),"skills"==e.typeName&&(n+=":J"+e.baseJobName),e.pve&&(n+=":V"+e.pve)),e.name&&!t&&(n+=":."+e.name.replace(/ /g,"-").replace(/\//g," ")),n}return""},decodeItem:function(e){var n={};return e&&angular.forEach(e.split(":"),function(e,a){if("I"==e.charAt(0))n.id=parseInt(e.substr(1),36);else if("E"==e.charAt(0))n.enchantmentNum=parseInt(e.substr(1),36);else if("P"==e.charAt(0))n.pid=parseInt(e.substr(1),36);else if("S"==e.charAt(0))n.setId=parseInt(e.substr(1),36);else if("H"==e.charAt(0))n.sparkId=parseInt(e.substr(1),36);else if("J"==e.charAt(0))n.baseJobName=e.substr(1);else if("V"==e.charAt(0))n.pve=e.substr(1);else if("_"==e.charAt(0))n.itemSource=e.substr(1);else if("."==e.charAt(0))n.name=e.substr(1).replace("-"," ");else if("C"==e.charAt(0)){n.stats=[];var i=e.substr(1);angular.forEach(i.split("|"),function(e,t){var a=e.split("=");n.stats.push({id:parseInt(a[0],36),max:Number(a[1])})})}else"F"==e.charAt(0)&&(n.fileName=e.substr(1),angular.forEach(t,function(e,t){e.mainDnt&&0==e.mainDnt.indexOf(n.fileName+".")&&(n.itemSource=t)}))}),n},createGroupLink:function(e,t){var n=[],a=this;if(null==t)return"";angular.forEach(t.items,function(e,t){var i=a.encodeItem(e,!0);i&&i.length&&n.push(i)});var i="view-group?region=";return m.dntLocation&&m.dntLocation.region&&(i+=m.dntLocation.region),t.enemyLevel&&(i+="&e="+t.enemyLevel),t.playerLevel&&(i+="&p="+t.playerLevel),t.heroLevel&&(i+="&h="+t.heroLevel),t.job&&t.job.id&&(i+="&j="+t.job.id),t.damageType&&t.damageType.id&&(i+="&d="+t.damageType.id),t.element&&t.element.id&&(i+="&t="+t.element.id),t.secondaryElement&&t.secondaryElement.id&&(i+="&s="+t.secondaryElement.id),i+="&g="+encodeURI(e)+"&i="+n.join(",")},reloadSkill:function(e){e.enchantmentNum||(e.enchantmentNum=1);var t="skilltable_character"+e.baseJobName+".lzjson",a="pve";"pvp"==e.pve&&(a="pvp");var l="skillleveltable_character"+e.baseJobName+a+".lzjson",s=n.find(t,"id",e.id)[0];s||console.log("cannot get skill data from ",t);var m=n.getData(l),c={};angular.forEach(m,function(t,n){t.SkillIndex==e.id&&t.SkillLevel==e.enchantmentNum&&(c=t)});var u={id:e.id,itemSource:e.itemSource,typeName:e.itemSource,needJobClass:s.NeedJob,baseJobName:e.baseJobName,rank:i.rankNames[0],enchantmentNum:e.enchantmentNum,name:o.translate(s.NameID,s.NameIDParam),description:o.translate(c.SkillExplanationID,c.SkillExplanationIDParam),icon:s.IconImageIndex,pve:e.pve};return u.stats=r.getSkillStats(u,s,m),u},reloadSourceItem:function(e){var l=t[e.itemSource],r=n.findFast(l.mainDnt,"id",e.id);if(!r.length)return void console.log("item "+e.id+" not found in "+l.mainDnt);var o=r[0],m=n.getValue(l.mainDnt,o,"TypeParam1"),c=null,u=n.find(l.potentialDnt,"id",e.pid);u.length||(u=n.find(l.potentialDnt,"PotentialID",m)),u.length||(u=n.find(l.potentialDntEx,"id",e.pid),u.length||(u=n.find(l.potentialDntEx,"PotentialID",m))),u.length>0&&(c=u[0],c.PotentialID!=m&&(c=null,console.log("bad potential")));var d=a.createItem(l,o,c);a.initItem(d),s.setItemCategory(d),d.gemSlot=e.gemSlot;var f=null;if((f="weapons"!=d.typeName&&0!=d.typeId?"partsDnt":"weaponDnt")&&n.isLoaded(l[f])&&n.isLoaded(l.setDnt)){d.setStats=[];var p=n.find(l[f],"id",e.id);if(p.length>0){d.setId=p[0].SetItemID;var h=n.find(l.setDnt,"id",p[0].SetItemID);h.length>0&&(d.setStats=i.getStats(h[0]))}}if(d.fullStats=d.stats,e.enchantmentNum>=0)if(d.enchantmentNum=e.enchantmentNum,"skills"==d.typeName);else if("talisman"==d.typeName){var S=[];angular.forEach(d.stats,function(e,t){S.push({id:e.id,max:Math.floor(e.max)*(d.enchantmentNum/100)})}),d.enchantmentStats=S}else if(l.enchantDnt){var g=n.find(l.enchantDnt,"EnchantID",d.enchantmentId);!g.length&&l.enchantDnt2&&(g=n.find(l.enchantDnt2,"EnchantID",d.enchantmentId)),angular.forEach(g,function(e,t){e.EnchantLevel==d.enchantmentNum&&(d.enchantmentStats=i.getStats(e))})}else if(l.petLevelDnt){var v=n.find(l.petLevelDnt,"PetLevelTypeID",d.enchantmentId);angular.forEach(v,function(e,t){e.PetLevel==d.enchantmentNum&&(d.enchantmentStats=i.getStats(e))})}if(d.enchantmentStats&&(d.fullStats=i.mergeStats(d.enchantmentStats,d.stats)),e.sparkId>0){d.sparkId=e.sparkId;var N=n.find(l.sparkDnt,"id",e.sparkId);N.length>0&&(d.sparkStats=i.getStats(N[0]),d.fullStats=i.mergeStats(d.fullStats,d.sparkStats))}else if(d.dragonjeweltype){d.offensiveGemSlots=0,d.increasingGemSlots=0;var D=n.find("dragonjewelslottable.lzjson","DragonJewelID",d.dragonjeweltype);D&&D.length>0&&(1==D[0].DragonJewelSlot1&&d.offensiveGemSlots++,1==D[0].DragonJewelSlot2&&d.offensiveGemSlots++,1==D[0].DragonJewelSlot3&&d.offensiveGemSlots++,1==D[0].DragonJewelSlot4&&d.offensiveGemSlots++,2==D[0].DragonJewelSlot1&&d.increasingGemSlots++,2==D[0].DragonJewelSlot2&&d.increasingGemSlots++,2==D[0].DragonJewelSlot3&&d.increasingGemSlots++,2==D[0].DragonJewelSlot4&&d.increasingGemSlots++)}return d},reloadItem:function(e){if(null!=e){if("itemTypeName"in e&&!e.itemSource&&(e.itemSource=e.itemTypeName),"rbTech"==e.itemSource&&(e.itemSource="tech"),"custom"==e.itemSource||"custom"==e.typeName)return e.typeName="custom",e;if("skills"==e.itemSource||"skills"==e.typeName)return this.reloadSkill(e);if(e.itemSource in t){var i=t[e.itemSource];if(n.findFast(i.mainDnt,"id",e.id).length)return this.reloadSourceItem(e)}if(e.fileName){var l=n.findFast(e.fileName+".lzjson","id",e.id);if(l.length>0){var r=l[0],s=n.getRow(e.fileName+".lzjson",r),m=a.createBasicItem(s);return m.row=r,m.needJobClass=s.NeedJobClass,m.exchangeType=s.ExchangeType,m.fileName=e.fileName,m.gemSlot=e.gemSlot,m.description=o.translate(s.DescriptionID,s.DescriptionIDParam),a.initItem(m),m}return{name:"unknown item"}}return{name:"unknown item source: "+e.itemSource}}},getDntFiles:function(e){if(null==e)return{};var n={};if(!e.itemSource&&e.itemTypeName in t&&(e.itemSource=e.itemTypeName),"rbTech"==e.itemSource&&(e.itemSource="tech"),e.itemSource in t){var a=t[e.itemSource];n["exchange.lzjson"]=null,n[a.mainDnt]=l.mainDnt;for(var i in a)i.indexOf("Dnt")>0&&("enchantDnt"!=i||"enchantDnt2"!=i||e.enchantmentNum)&&(n[a[i]]=l[i])}if("skills"==e.itemSource||"skills"==e.typeName){n["skilltable_character"+e.baseJobName+".lzjson"]=null;var r="skillleveltable_character"+e.baseJobName+"pve.lzjson";n[r]=null,r="skillleveltable_character"+e.baseJobName+"pvp.lzjson",n[r]=null}return e.fileName&&(n[e.fileName+".lzjson"]=null),n}}}e.$inject=["$http","items","dntData","itemFactory","hCodeValues","itemColumnsToLoad","statHelper","translations","itemCategory","region"],angular.module("dnsim").factory("exportLinkHelper",e)}();
...
"use strict";!function(){function e(e,t,a,n,p,S,i,m,s){return{categorySteps:{titles:["titleStep"],weapons:["exchangeStep","levelStep","rankStep","itemNameStep","hasStatStep","itemStep","enhanceEqStep"],armour:["exchangeStep","levelStep","rankStep","itemNameStep","hasStatStep","itemStep","enhanceEqStep"],accessories:["accExchangeStep","levelStep","rankStep","itemNameStep","hasStatStep","itemStep"],techs:["exchangeStep","levelStep","rankStep","techSkillStep","itemNameStep","hasStatStep","itemStep"],"offensive gems":["levelStep","gemRankStep","itemNameStep","numStatsStep","hasStatStep","itemStep","enhanceGemStep"],"increasing gems":["levelStep","gemRankStep","itemNameStep","numStatsStep","hasStatStep","itemStep","enhanceGemStep"],"enhancement plates":["levelStep","rankStep","distinctItemNameStep","numStatsStep","hasStatStep","itemStep"],"expedition plates":["levelStep","distinctItemNameStep","numStatsStep","highStatStep","hasStatStep","itemStep"],talisman:["levelStep","talismanRankStep","distinctItemNameStep","numStatsStep","hasStatStep","itemStep","enhanceTalismanStep"],costume:["exchangeStep","rankStep","itemNameStep","itemStep"],imprint:["rankStep","itemNameStep","highStatStep","itemStep"],cash:["accExchangeStep","rankStep","itemNameStep","itemStep"],custom:["customStep"]},getOptions:function(e,t,a){var n=this;if(e.name in this.categorySteps){var p=this.getStepName(e,a.length),S=m[p],i=S.getOptions(e,t,a);if(S.isItemStep)return i;if(S.minOptions)var r=s.findData(e,t,a,50);var c=_.filter(i,function(p){var m,c=a.concat([n.createData(p,e,a.length)]);if(S.minOptions){if(i[0]==p)return!0;if(m=s.findData(e,t,c,50),m.length>0&&m.length<50)return m.length<r.length}else m=s.findData(e,t,c,1);return m.length});return S.minOptions&&c.length<S.minOptions?[i[0]]:c}return[]},hasOptions:function(e,t,a){if(e.name in this.categorySteps){var n=this.getStepName(e,a.length);return m[n].hasOptions?m[n].hasOptions(e,t,a):m[n].getOptions(e,t,a).length>0}return!1},isValidStepNumber:function(e,t){return this.categorySteps[e.name].length>t},createData:function(e,t,a){var n=this.getStepName(t,a);return{step:n,value:e,def:m[n]}},getItem:s.getItem,getStepName:function(e,t){return this.categorySteps[e.name][t]}}}e.$inject=["dntData","translations","itemColumnsToLoad","itemCategory","itemFactory","jobs","hCodeValues","quickAddSteps","quickAddHelper"],angular.module("dnsim").factory("quickAdd",e)}();
"use strict";!function(){function e(e,n,t,a,i,m,r,s){return{exchangeStep:{name:"type",getOptions:function(t,a,i){for(var m=[],r=0;r<t.limitExchange.length;++r){var s=t.limitExchange[r],o=0;if(a.items)for(var c=0;c<a.items.length;++c)a.items[c].exchangeType==s&&o++;if(!(o>=t.maxExchange)){var h=e.find("exchange.lzjson","ExchangeType",s),d="";h&&h.length>0&&h[0].NameID>0&&(d=n.translate(h[0].NameID).toLowerCase()),m.push({id:s,name:d.toLowerCase()})}}return m},matchesItem:function(e,n){return n.exchangeType==e}},accExchangeStep:{name:"type",getOptions:function(t,a,i){for(var m=[],r=0;r<t.limitExchange.length;++r){for(var s=t.limitExchange[r],o=0,c=0;c<a.items.length;++c)a.items[c]&&a.items[c].exchangeType==s&&o++;if(10==s||25==s){if(o>=2)continue}else if(o>=1)continue;var h=e.find("exchange.lzjson","ExchangeType",s);if(h&&h.length>0&&h[0].NameID>0){var d=n.translate(h[0].NameID).toLowerCase();m.push({id:s,name:d.toLowerCase()})}}return m},matchesItem:function(e,n){return n.exchangeType==e}},levelStep:{name:"level",getOptions:function(e,n,t){return[{id:95,name:"level 95"},{id:93,name:"level 93"},{id:90,name:"level 90"},{id:80,name:"level 80"},{id:70,name:"level 70"},{id:60,name:"level 60"},{id:50,name:"level 50"},{id:40,name:"level 40"},{id:32,name:"level 32"},{id:24,name:"level 24"}]},matchesItem:function(e,n){return n.levelLimit==e}},talismanRankStep:{name:"rank",getOptions:function(e,n,t){return[{id:3,name:"epic"},{id:2,name:"rare"},{id:999,name:"quality high grade"},{id:1,name:"magic"},{id:0,name:"normal"}]},matchesItem:function(e,n){if(i.initItem(n),n.name){var t=Math.max(n.name.indexOf("Quality"),n.name.indexOf("High Grade"));return 999==e?0===t:n.rank&&n.rank.id==e&&0!=t}return!1}},gemRankStep:{name:"rank",getOptions:function(e,n,t){return[{id:5,name:"legendary"},{id:4,name:"unique"},{id:999,name:"quality high grade epic"},{id:3,name:"epic"}]},matchesItem:function(e,n){if(i.initItem(n),n.name){var t=Math.max(n.name.indexOf("Quality"),n.name.indexOf("High Grade"));return 999==e?n.rank&&3==n.rank.id&&t>=0:n.rank&&n.rank.id==e&&t<0}return!1}},rankStep:{name:"rank",getOptions:function(e,n,t){var a=[];for(var i in r.rankNames)a.push(r.rankNames[i]);return a},matchesItem:function(e,n){return n.rank&&n.rank.id==e}},enhanceTalismanStep:{name:"slot",getOptions:function(e,n,t){return[{id:100,name:"+100% slot"},{id:75,name:"+75% slot"},{id:25,name:"+25% slot"},{id:0,name:"+0% slot"}]},alterItem:function(e,n){n.enchantmentNum=e}},titleStep:{name:"select",getOptions:function(e,n,t){for(var a=s.findData(e,n,t,9999),i=[],m=0;m<a.length;++m)switch(a[m].id){case 1975:case 1973:case 1008:case 230:case 279:case 2032:case 2033:case 1313:case 2188:i.push(a[m])}return i},hasOptions:function(e,n,t){return!0},isItemStep:!0},enhanceEqStep:{name:"enhance",getOptions:function(e,n,t){var a=s.getItem(t);return a&&a.enchantmentId?[{id:20,name:"enhance to +20"},{id:19,name:"enhance to +19"},{id:18,name:"enhance to +18"},{id:17,name:"enhance to +17"},{id:16,name:"enhance to +16"},{id:15,name:"enhance to +15"},{id:14,name:"enhance to +14"},{id:13,name:"enhance to +13"},{id:12,name:"enhance to +12"},{id:11,name:"enhance to +11"},{id:10,name:"enhance to +10"},{id:9,name:"enhance to +9"},{id:8,name:"enhance to +8"},{id:7,name:"enhance to +7"},{id:6,name:"enhance to +6"},{id:5,name:"enhance to +5"},{id:4,name:"enhance to +4"},{id:3,name:"enhance to +3"},{id:2,name:"enhance to +2"},{id:1,name:"enhance to +1"},{id:0,name:"not enhanced"}]:[{id:0,name:"not enhanced"}]},alterItem:function(e,n){n.enchantmentNum=e}},enhanceGemStep:{name:"enhance",getOptions:function(e,n,t){var a=s.getItem(t);return a&&a.enchantmentId?[{id:15,name:"enhance to +15"},{id:14,name:"enhance to +14"},{id:13,name:"enhance to +13"},{id:12,name:"enhance to +12"},{id:11,name:"enhance to +11"},{id:10,name:"enhance to +10"},{id:9,name:"enhance to +9"},{id:8,name:"enhance to +8"},{id:7,name:"enhance to +7"},{id:6,name:"enhance to +6"},{id:5,name:"enhance to +5"},{id:4,name:"enhance to +4"},{id:3,name:"enhance to +3"},{id:2,name:"enhance to +2"},{id:1,name:"enhance to +1"},{id:0,name:"not enhanced"}]:[{id:0,name:"not enhanced"}]},alterItem:function(e,n){n.enchantmentNum=e}},itemStep:{name:"select",getOptions:function(e,n,t){return s.findData(e,n,t)},isItemStep:!0,hideName:!0},namedItemStep:{name:"select",getOptions:function(e,n,t){return s.findData(e,n,t)},isItemStep:!0},techSkillStep:{name:"skill",getOptions:function(e,n,t){var a=s.findData(e,n,t,1);return a.length>0?[{id:a[0].skillId,name:a[0].skillId}]:[]},matchesItem:function(e,n){return n.skillId==e}},itemNameStep:{name:"item",getOptions:function(e,n,t){for(var a=s.findData(e,n,t),i={},m=[],r=0;r<a.length;++r){var o=a[r].name;o in i||(i[o]=!0,m.push({id:o,name:o}))}return m},matchesItem:function(e,n){return n.name==e},isItemStep:!0},distinctItemNameStep:{name:"item",getOptions:function(e,n,t){for(var a=s.findData(e,n,t),i={},m=[],r=0;r<n.items.length;++r){i[n.items[r].name]=!0}for(var r=0;r<a.length;++r){var o=a[r].name;o in i||(i[o]=!0,m.push({id:o,name:o}))}return m},matchesItem:function(e,n){return n.name==e},isItemStep:!0},numStatsStep:{name:"Num Stats",getOptions:function(e,n,t){for(var a=s.findData(e,n,t),i={},m=0;m<a.length;++m){for(var o=0,c=0;c<a[m].stats.length;++c){var h=r.stats[a[m].stats[c].id];h&&!h.hide&&o++}i[o+"x stats"]=o}var d=[];for(var u in i)d.push({id:i[u],name:u});return d=d.sort(function(e,n){return e.id-n.id})},matchesItem:function(e,n){for(var t=0,a=0;a<n.stats.length;++a){var i=r.stats[n.stats[a].id];i&&!i.hide&&t++}return t==e},isItemStep:!0},highStatStep:{name:"High Stat",getOptions:function(e,n,t){var a=s.findData(e,n,t),i={id:-1,name:"all"},m=[i];if(a.length>1){for(var o={},c=0;c<a.length;++c)for(var h=0;h<a[c].stats.length;++h){var d=r.stats[a[c].stats[h].id];!d||!d.quickHigh||"high "+d.name in o||(o["high "+d.name]=d.id)}for(var u in o)m.push({id:o[u],name:u});m=m.length<=2?[i]:m.sort(function(e,n){return e.id-n.id})}return m},matchesItem:function(e,n){if(e==-1)return!0;for(var t=0,a=0,i=0;i<n.stats.length;++i){var m=n.stats[i];r.stats[m.id].quickHigh&&(m.id==e?a+=m.max:m.max>t&&(t=m.max))}return a>t},sortFunc:function(e,n,t){for(var a=0,i=0,m=0;m<n.stats.length;++m)if(n.stats[m].id==e){a=n.stats[m].max;break}for(var r=0;r<t.stats.length;++r)if(t.stats[r].id==e){i=t.stats[r].max;break}return i-a},isItemStep:!1,minOptions:3},hasStatStep:{name:"Has Stat",getOptions:function(e,n,t){var a=s.findData(e,n,t),i={id:-1,name:"all"},m=[i];if(a.length>1){for(var o={},c=0;c<a.length;++c)for(var h=0;h<a[c].stats.length;++h){var d=r.stats[a[c].stats[h].id];!d||!d.searchable||"high "+d.name in o||(o["has "+d.name]=d.id)}for(var u in o)m.push({id:o[u],name:u});m=m.length<=2?[i]:m.sort(function(e,n){return e.id-n.id})}return m},matchesItem:function(e,n){if(e==-1)return!0;for(var t=0;t<n.stats.length;++t){var a=n.stats[t];if(r.stats[a.id].searchable&&a.id==e)return!0}return!1},sortFunc:function(e,n,t){for(var a=0,i=0,m=0;m<n.stats.length;++m)if(n.stats[m].id==e){a=n.stats[m].max;break}for(var r=0;r<t.stats.length;++r)if(t.stats[r].id==e){i=t.stats[r].max;break}return i-a},isItemStep:!1,minOptions:3},customStep:{name:"misc",getOptions:function(e,n,t){return r.customItems},isItemStep:!0}}}e.$inject=["dntData","translations","itemColumnsToLoad","itemCategory","itemFactory","jobs","hCodeValues","quickAddHelper"],angular.module("dnsim").factory("quickAddSteps",e)}();
"use strict";!function(){function t(t,i,e,n){var o={region:"ALT",name:"Alternative user specified files",url:""},a=[{region:"sea",name:"south east asia",url:"https://seadnfiles.netlify.com/public"},{region:"na",name:"north america",url:"https://nadnfiles.netlify.com/public"},{region:"eu",name:"europe",url:"https://eudnfiles.netlify.com/public"},{region:"th",name:"thailand",url:"https://thdnfiles.netlify.com/public"},{region:"tw",name:"taiwan 臺灣",url:"https://tdnfiles.netlify.com/public"},{region:"cdn",name:"china 中國",url:"https://cdnfiles.netlify.com/public"},{region:"kdn",name:"korea 대한민국",url:"https://kdnfiles.netlify.com/public"}],l=localStorage.getItem("lastDNTRegion"),r=null;l&&angular.forEach(a,function(t,i){t.region==l&&(r=t)});var s=localStorage.getItem("UIStrings_file"),c=null;return s&&angular.forEach(a,function(t,i){t.region!=o.region&&s.indexOf(t.url)>-1&&(c=t)}),null==c&&(c=r),{hostedFiles:a,alternativeFiles:o,dntLocation:r,tlocation:c,setCustomUrl:function(t){this.alternativeFiles.url=t;var i=[];angular.forEach(a,function(t,e){t.region!=o.region&&i.push(t)}),i.push(o),a=i,this.hostedFiles=i},setLocationByName:function(t){var i=null;angular.forEach(a,function(e,n){e.region==t&&(i=e)}),this.setLocation(i)},setLocation:function(t){t&&t!=this.dntLocation&&(this.dntLocation=t,i(),localStorage.setItem("lastDNTRegion",t.region),i(),n.reload());var e=this.getOverride();null!=this.tlocation&&e||this.setTLocation(t),this.init()},setTLocation:function(e){if(e!=this.tlocation&&(this.tlocation=e,sessionStorage.removeItem("UIStrings"),localStorage.removeItem("UIStrings_file"),i(),t.reset(),e)){var o=this.getOverride();t.small=!o,t.location=this.tlocation.url,t.region=this.tlocation.region,t.init(function(){},function(){n.reload()})}},getOverride:function(){return!!localStorage.getItem("tOverride")},setOverride:function(t){t?localStorage.setItem("tOverride","1"):localStorage.removeItem("tOverride"),this.setTLocation(this.dntLocation)},init:function(){this.getOverride()?t.small=!1:(this.tLocation=this.dntLocation,t.small=!0),this.tlocation&&(t.location=this.tlocation.url,t.region=this.tlocation.region),e.setLocation(this.dntLocation)}}}angular.module("dnsim").factory("region",["translations","dntReset","dntData","$route",t])}();
