...
"use strict";!function(){function n(n,t){return{restrict:"A",scope:{stats:"=stats",build:"=build",altStats:"=altStats",separator:"=separator",filter:"=filter",numInSet:"=numInSet"},link:function(e,i,a){function r(){function a(n){var t=i.clone();t.css("display",u),t.html(n),f.after(t),f=t,d.push(t)}i.css("display","none");var r=e.stats;r||(r=e.altStats),angular.forEach(d,function(n,t){n.remove()});var o=!0,f=i,l={};angular.forEach(r,function(t,e){var i=n.stats[t.id];i&&i.summaryFor&&(l[i.summaryFor]=t)}),angular.forEach(r,function(i,d){var u="";if(i.id in n.stats){var f=n.stats[i.id];if(!e.filter&&"hide"in f&&f.hide)return;if(e.filter&&!f[e.filter])return;if(f.summaryFor)return;if("hideIf"in f&&f.hideIf>0){if(_.find(r,function(n){return n.id==f.hideIf}))return}if(_.find(r,function(t){return n.stats[t.id].addTo==f.id}))return;if("addTo"in f&&f.addTo>0){var m=_.find(r,function(n){return n.id==f.addTo});m&&(i=_.clone(i),i.max+=m.max)}if(o||(u+=s),o=!1,"needSetNum"in i&&(i.needSetNum<=e.numInSet&&(u+="*"),u+=i.needSetNum+"&nbsp;"),u+="<strong>",e.build)if("primary"==f.element){var c=0;e.build.element&&(c=e.build.element.id),u+=t.instant(n.elements[c].name)+"&nbsp;"}else if("secondary"==f.element){var c=0;e.build.secondaryElement&&(c=e.build.secondaryElement.id),u+=t.instant(n.elements[c].name)+"&nbsp;"}if(u+=t.instant(f.name)+":</strong>&nbsp;"+f.display(i),f.combineWith>0&&angular.forEach(r,function(n,t){if(n.id==f.combineWith){if("addTo"in f&&f.addTo>0){var e=_.find(r,function(n){return n.id==f.addTo});e&&(n=_.clone(n),n.max+=e.max)}n.max!=i.max&&(u+="-"+f.display(n))}}),i.id in l){var p=l[i.id];u+="&nbsp;|&nbsp;<em>"+n.stats[p.id].display(p),u+="</em>"}}else o||(u+=s),o=!1,"needSetNum"in i&&(u+=i.needSetNum+"-Increases&nbsp;"),u+=i.id+":&nbsp;"+i.max;a(u)})}var s;s=e.separator?"&nbsp;"+e.separator+" ":"";var d=[],u=i.css("display");e.$watch("stats",function(n,t){n&&r()}),e.$watch("altStats",function(n,t){n&&r()}),e.$watch("numInSet",function(n,t){n>=0&&r()})}}}angular.module("dnsim").directive("dnsimStats",["hCodeValues","$translate",n])}();
