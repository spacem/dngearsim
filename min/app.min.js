...
"use strict";angular.module("dnsim").controller("itemViewTuningCtrl",["$timeout","dntData","itemFactory","hCodeValues",function(e,t,i,n){if(null!=this.item){var r=this;r.rewardItems=[];for(var l=["all-items.lzjson","itemchangetable.lzjson"],a=0;a<l.length;++a)t.init(l[a],null,function(){},function(){e(function(){r.initTransfers()})});this.initTransfers=function(){for(var e=0;e<l.length;++e)if(!t.isLoaded(l[e]))return;r.rewardItems=[];var n=t.find("itemchangetable.lzjson","OriginalItemID",r.item.id);if(n&&n.length>0)for(var a=0;a<n.length;++a){var m=n[a];if(m.OriginalLevel==r.item.enchantmentNum||!m.OriginalLevel){var o=t.find("all-items.lzjson","id",m.RewardItemID);r.rewardItems.push({rewardItem:i.createBasicItem(o[0])})}}}}}]).directive("dngearsimItemViewTuning",function(){return{scope:!0,bindToController:{item:"=item"},controller:"itemViewTuningCtrl",controllerAs:"ctrl",templateUrl:"ui/item/item-view-tuning.html"}});
