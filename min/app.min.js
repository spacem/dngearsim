...
"use strict";!function(){function e(e,t,n,a,i,l,r,s,o,m){return{encodeItem:function(e,t){if(e){var n;return"custom"==e.typeName?(n="_custom",angular.forEach(e.stats,function(e,t){n+=t>0?"|":":C",n+=e.id.toString(36)+"="+e.max})):e.id&&(n="I"+e.id.toString(36)+":_","itemSource"in e?n+=e.itemSource:"itemTypeName"in e?n+=e.itemTypeName:e.fileName&&(n+=":F"+e.fileName),(e.enchantmentNum||0==e.enchantmentNum)&&(n+=":E"+e.enchantmentNum.toString(36)),e.pid>0&&(n+=":P"+e.pid.toString(36)),e.sparkId>0&&(n+=":H"+e.sparkId.toString(36)),"skills"==e.typeName&&(n+=":J"+e.baseJobName),e.pve&&(n+=":V"+e.pve)),e.name&&!t&&(n+=":."+e.name.replace(/ /g,"-").replace(/\//g," ")),n}return""},decodeItem:function(e){var n={};return e&&angular.forEach(e.split(":"),function(e,a){if("I"==e.charAt(0))n.id=parseInt(e.substr(1),36);else if("E"==e.charAt(0))n.enchantmentNum=parseInt(e.substr(1),36);else if("P"==e.charAt(0))n.pid=parseInt(e.substr(1),36);else if("S"==e.charAt(0))n.setId=parseInt(e.substr(1),36);else if("H"==e.charAt(0))n.sparkId=parseInt(e.substr(1),36);else if("J"==e.charAt(0))n.baseJobName=e.substr(1);else if("V"==e.charAt(0))n.pve=e.substr(1);else if("_"==e.charAt(0))n.itemSource=e.substr(1);else if("."==e.charAt(0))n.name=e.substr(1).replace("-"," ");else if("C"==e.charAt(0)){n.stats=[];var i=e.substr(1);angular.forEach(i.split("|"),function(e,t){var a=e.split("=");n.stats.push({id:parseInt(a[0],36),max:Number(a[1])})})}else"F"==e.charAt(0)&&(n.fileName=e.substr(1),angular.forEach(t,function(e,t){e.mainDnt&&0==e.mainDnt.indexOf(n.fileName+".")&&(n.itemSource=t)}))}),n},createGroupLink:function(e,t){var n=[],a=this;if(null==t)return"";angular.forEach(t.items,function(e,t){var i=a.encodeItem(e,!0);i&&i.length&&n.push(i)});var i="view-group?region=";return m.dntLocation&&m.dntLocation.region&&(i+=m.dntLocation.region),t.enemyLevel&&(i+="&e="+t.enemyLevel),t.playerLevel&&(i+="&p="+t.playerLevel),t.heroLevel&&(i+="&h="+t.heroLevel),t.job&&t.job.id&&(i+="&j="+t.job.id),t.damageType&&t.damageType.id&&(i+="&d="+t.damageType.id),t.element&&t.element.id&&(i+="&t="+t.element.id),t.secondaryElement&&t.secondaryElement.id&&(i+="&s="+t.secondaryElement.id),i+="&g="+encodeURI(e)+"&i="+n.join(",")},reloadSkill:function(e){e.enchantmentNum||(e.enchantmentNum=1);var t="skilltable_character"+e.baseJobName+".lzjson",a="pve";"pvp"==e.pve&&(a="pvp");var l="skillleveltable_character"+e.baseJobName+a+".lzjson",o=n.find(t,"id",e.id)[0];o||console.log("cannot get skill data from ",t);var m=n.getData(l),c={};angular.forEach(m,function(t,n){t.SkillIndex==e.id&&t.SkillLevel==e.enchantmentNum&&(c=t)});var u={id:e.id,itemSource:e.itemSource,typeName:e.itemSource,needJobClass:o.NeedJob,baseJobName:e.baseJobName,rank:i.rankNames[0],enchantmentNum:e.enchantmentNum,name:s.translate(o.NameID,o.NameIDParam),description:s.translate(c.SkillExplanationID,c.SkillExplanationIDParam),icon:o.IconImageIndex,pve:e.pve};return u.stats=r.getSkillStats(u,o,m),u},reloadSourceItem:function(e){var l=t[e.itemSource],r=n.findFast(l.mainDnt,"id",e.id);if(!r.length)return void console.log("item "+e.id+" not found in "+l.mainDnt);var s=r[0],m=n.getValue(l.mainDnt,s,"TypeParam1"),c=null,u=n.find(l.potentialDnt,"id",e.pid);u.length||(u=n.find(l.potentialDnt,"PotentialID",m)),u.length||(u=n.find(l.potentialDntEx,"id",e.pid),u.length||(u=n.find(l.potentialDntEx,"PotentialID",m))),u.length>0&&(c=u[0],c.PotentialID!=m&&(c=null,console.log("bad potential")));var d=a.createItem(l,s,c);a.initItem(d),o.setItemCategory(d),d.gemSlot=e.gemSlot;var f=null;if((f="weapons"!=d.typeName&&0!=d.typeId?"partsDnt":"weaponDnt")&&n.isLoaded(l[f])&&n.isLoaded(l.setDnt)){d.setStats=[];var p=n.find(l[f],"id",e.id);if(p.length>0){d.setId=p[0].SetItemID;var h=n.find(l.setDnt,"id",p[0].SetItemID);h.length>0&&(d.setStats=i.getStats(h[0]))}}if(d.fullStats=d.stats,e.enchantmentNum>=0)if(d.enchantmentNum=e.enchantmentNum,"skills"==d.typeName);else if("talisman"==d.typeName){var S=[],g=i.mergeStats(d.stats,[]);angular.forEach(g,function(e,t){S.push({id:e.id,max:e.max*(d.enchantmentNum/100)})}),d.enchantmentStats=S}else if(l.enchantDnt){var v=n.find(l.enchantDnt,"EnchantID",d.enchantmentId);!v.length&&l.enchantDnt2&&(v=n.find(l.enchantDnt2,"EnchantID",d.enchantmentId)),angular.forEach(v,function(e,t){e.EnchantLevel==d.enchantmentNum&&(d.enchantmentStats=i.getStats(e))})}else if(l.petLevelDnt){var N=n.find(l.petLevelDnt,"PetLevelTypeID",d.enchantmentId);angular.forEach(N,function(e,t){e.PetLevel==d.enchantmentNum&&(d.enchantmentStats=i.getStats(e))})}if(d.enchantmentStats&&(d.fullStats=i.mergeStats(d.enchantmentStats,d.stats)),e.sparkId>0){d.sparkId=e.sparkId;var D=n.find(l.sparkDnt,"id",e.sparkId);D.length>0&&(d.sparkStats=i.getStats(D[0]),d.fullStats=i.mergeStats(d.fullStats,d.sparkStats))}else if(d.dragonjeweltype){d.offensiveGemSlots=0,d.increasingGemSlots=0;var I=n.find("dragonjewelslottable.lzjson","DragonJewelID",d.dragonjeweltype);I&&I.length>0&&(1==I[0].DragonJewelSlot1&&d.offensiveGemSlots++,1==I[0].DragonJewelSlot2&&d.offensiveGemSlots++,1==I[0].DragonJewelSlot3&&d.offensiveGemSlots++,1==I[0].DragonJewelSlot4&&d.offensiveGemSlots++,2==I[0].DragonJewelSlot1&&d.increasingGemSlots++,2==I[0].DragonJewelSlot2&&d.increasingGemSlots++,2==I[0].DragonJewelSlot3&&d.increasingGemSlots++,2==I[0].DragonJewelSlot4&&d.increasingGemSlots++)}return d},reloadItem:function(e){if(null!=e){if("itemTypeName"in e&&!e.itemSource&&(e.itemSource=e.itemTypeName),"rbTech"==e.itemSource&&(e.itemSource="tech"),"custom"==e.itemSource||"custom"==e.typeName)return e.typeName="custom",e;if("skills"==e.itemSource||"skills"==e.typeName)return this.reloadSkill(e);if(e.itemSource in t){var i=t[e.itemSource];if(n.findFast(i.mainDnt,"id",e.id).length)return this.reloadSourceItem(e)}if(e.fileName){var l=n.findFast(e.fileName+".lzjson","id",e.id);if(l.length>0){var r=l[0],o=n.getRow(e.fileName+".lzjson",r),m=a.createBasicItem(o);return m.row=r,m.needJobClass=o.NeedJobClass,m.exchangeType=o.ExchangeType,m.fileName=e.fileName,m.gemSlot=e.gemSlot,m.description=s.translate(o.DescriptionID,o.DescriptionIDParam),a.initItem(m),m}return{name:"unknown item"}}return{name:"unknown item source: "+e.itemSource}}},getDntFiles:function(e){if(null==e)return{};var n={};if(!e.itemSource&&e.itemTypeName in t&&(e.itemSource=e.itemTypeName),"rbTech"==e.itemSource&&(e.itemSource="tech"),e.itemSource in t){var a=t[e.itemSource];n["exchange.lzjson"]=null,n[a.mainDnt]=l.mainDnt;for(var i in a)i.indexOf("Dnt")>0&&("enchantDnt"!=i||"enchantDnt2"!=i||e.enchantmentNum)&&(n[a[i]]=l[i])}if("skills"==e.itemSource||"skills"==e.typeName){n["skilltable_character"+e.baseJobName+".lzjson"]=null;var r="skillleveltable_character"+e.baseJobName+"pve.lzjson";n[r]=null,r="skillleveltable_character"+e.baseJobName+"pvp.lzjson",n[r]=null}return e.fileName&&(n[e.fileName+".lzjson"]=null),n}}}e.$inject=["$http","items","dntData","itemFactory","hCodeValues","itemColumnsToLoad","statHelper","translations","itemCategory","region"],angular.module("dnsim").factory("exportLinkHelper",e)}();
