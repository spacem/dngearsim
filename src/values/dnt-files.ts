export class DntFiles {
    static job = 'jobtable.json';
    static jobConversions = 'rebootplayerweighttable.json';
    static statCaps = 'playercommonleveltable.json';
    static jobBaseStats = 'playerleveltable.optimised.json';
    static heroLevels = 'heroleveltable.json';
