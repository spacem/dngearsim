...
function quickAdd(dntData, translations, itemColumnsToLoad, itemCategory,itemFactory,jobs,hCodeValues, quickAddSteps, quickAddHelper) {
  ...
  return {
    categorySteps: {
      ...
      techs: ['exchangeStep','allLevelStep','techRankStep','techSkillStep','itemNameStep','highStatStep','itemStep'],
      'offensive gems': ['sixtyLevelStep','gemRankStep','itemNameStep','hasStatStep','numStatsStep','itemStep','enhanceStep'],
      'increasing gems': ['sixtyLevelStep','gemRankStep','itemNameStep','hasStatStep','numStatsStep','itemStep','enhanceStep'],
