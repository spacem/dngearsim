...
function quickAdd(dntData, translations, itemColumnsToLoad, itemCategory,itemFactory,jobs,hCodeValues, quickAddSteps, quickAddHelper) {
  ...
  return {
    categorySteps: {
      ...
      'enhancement plates': ['allLevelStep','plateRankStep','distinctItemNameStep','numStatsStep','hasStatStep','itemStep'],
      ...
      costume: ['exchangeStep','cashRankStep','itemNameStep','itemStep'],
